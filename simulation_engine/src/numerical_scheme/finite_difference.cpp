/* 
Function for computing the solution to the mean field Kuramoto PDE 
with noise level D and coupling strength K, using a Lax-Friedrichs 
scheme and taking care of the periodic boundary conditions.
*/
...
void finiteDifference(
    ...
    OrderParameter r =  computeR(f, g, thetaPoints, dTheta, 
                                 cosine, sine, frequencyPoints, dFrequency);
