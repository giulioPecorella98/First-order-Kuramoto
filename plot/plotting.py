...
def data_analysis():
    ...
    print("2) Plot the order parameter dependency on K for a specified",
          "condition")
    ...
    while (choice != "1" and choice != "2" and choice != "3"):
        ...
        print("1) Plot the density evolution of a saved simulation")
        print("2) Plot the order parameter dependency on K for a ",
              "specified condition")
        print("3) Return to the main menu")
        choice = input("Please type your choice: ")
    
    if choice == "1":
        de.density_evolution()
    
    elif choice == "2":
        ope.order_parameter_evolution()
